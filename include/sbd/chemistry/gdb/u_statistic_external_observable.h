#ifndef SBD_GDB_U_STATISTIC_EXTERNAL_OBSERVABLE_H
#define SBD_GDB_U_STATISTIC_EXTERNAL_OBSERVABLE_H
...
UStatisticExternalObservable<RealT> u_statistic_external_observable(
  ...
  return u_statistic_external_observable_sorted_basis<ElemT, RealT>(
      children, contributions, sorted_basis, sample_count, bit_length, norb,
      scalar_integral, one_integrals, two_integrals, reference_energy,
